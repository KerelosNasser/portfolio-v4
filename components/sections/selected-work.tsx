...
export function SelectedWork() {
  ...
  return (
    <section id="work" className="py-24 md:py-32 lg:py-40 border-b border-border">
      <Container>
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-20 md:mb-28">
          <div className="space-y-3 max-w-xl">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground">
              Real products built to solve real problems.
            </h2>
          </div>
          ...
          <article className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="space-y-2">
                <span className="font-mono text-xs text-[#00A86B] dark:text-[#20C67A]">
                  01 / E-COMMERCE & WEB APP
                </span>
              ...
              <div className="flex flex-wrap items-center gap-2 pt-1">
                {p1.technologies.map((t) => (
                  <span
                    key={t}
                    className="font-mono text-[11px] text-muted-foreground bg-secondary px-2.5 py-1 rounded border border-border"
                  >
                    {t}
                  </span>
                ))}
                ...
                <div className="p-5 space-y-4 bg-card">
                  ...
                  <div className="flex items-center justify-between pb-3 border-b border-border">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-1 text-xs text-[#00A86B] dark:text-[#20C67A] bg-[#00A86B]/10 dark:bg-[#20C67A]/15 px-2.5 py-1 rounded border border-[#00A86B]/20">
                  ...
                  <div className="rounded border border-border bg-background p-4 space-y-2">
                    ...
                    <div className="h-36 w-full pt-2">
                      <svg viewBox="0 0 500 120" className="w-full h-full overflow-visible">
                        {/* Grid lines */}
                        <line x1="0" y1="20" x2="500" y2="20" stroke="currentColor" className="text-border" strokeWidth="1" />
                        <line x1="0" y1="60" x2="500" y2="60" stroke="currentColor" className="text-border" strokeWidth="1" />
                        <line x1="0" y1="100" x2="500" y2="100" stroke="currentColor" className="text-border" strokeWidth="1" />
                        ...
                        <polygon
                          ...
                          fill="#00A86B"
                          className="dark:fill-[#20C67A]"
                          fillOpacity="0.08"
                        />

                        {/* Data point dots */}
                        <circle cx="220" cy="70" r="3.5" fill="#00A86B" className="dark:fill-[#20C67A]" />
                        <circle cx="380" cy="35" r="3.5" fill="#00A86B" className="dark:fill-[#20C67A]" />
                        <circle cx="500" cy="15" r="4" fill="#FFFFFF" stroke="#00A86B" className="dark:stroke-[#20C67A]" strokeWidth="2" />
                      </svg>
                    </div>
          ...
          <article className="space-y-8">
            ...
            <div className="rounded-lg border border-border bg-card shadow-md overflow-hidden transition-all duration-300 hover:border-[#00A86B]/30 dark:hover:border-[#20C67A]/30">
              ...
              <div className="flex items-center justify-between px-3.5 py-2.5 border-b border-border bg-secondary/70 text-xs text-muted-foreground">
                ...
                <span className="text-[11px] font-mono text-muted-foreground">App Router</span>
              </div>

              {/* SaaS App Layout Representation */}
              <div className="grid grid-cols-1 md:grid-cols-12 min-h-[220px] bg-card">
                {/* Sidebar Mockup (3 cols) */}
                <div className="hidden md:block md:col-span-3 border-r border-border p-4 space-y-4 bg-secondary/30">
                  <div className="flex items-center gap-2 px-1">
                    <div className="h-5 w-5 rounded bg-[#00A86B] text-white dark:bg-[#20C67A] dark:text-[#0D110F] flex items-center justify-center text-[10px] font-bold">
                      S
                    </div>
                    <span className="text-xs font-semibold text-foreground">Acme SaaS</span>
                  </div>

                  <div className="space-y-1 text-xs">
                    <div className="rounded bg-secondary text-foreground px-2.5 py-1.5 font-medium">
                      Overview
                    </div>
                    <div className="text-muted-foreground px-2.5 py-1.5 hover:text-foreground">
                      Workspaces
                    </div>
                    <div className="text-muted-foreground px-2.5 py-1.5 hover:text-foreground">
                      Integrations
                ...
                <div className="md:col-span-9 p-5 space-y-4">
                  <div className="flex items-center justify-between border-b border-border pb-3">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">App Router layout baseline</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="font-mono text-xs text-muted-foreground bg-secondary px-2 py-1 rounded border border-border">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div className="rounded border border-border bg-background p-3 space-y-1">
                      <p className="text-[11px] text-muted-foreground">Layout Structure</p>
                      <p className="text-sm font-semibold text-foreground">Server Components</p>
                      <p className="text-[10px] text-muted-foreground">Isolated interactive islands</p>
                    </div>
